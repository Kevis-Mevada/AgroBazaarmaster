...
<head>
    ...
    <meta name="description" content="Login to your AgroCraft farmer account - Sell directly to buyers. Fair prices. No middlemen.">
...
<body>
    ...
    <div class="container">
        <header>
            ...
            <nav>
                ...
                <a href="FarmerRegister.php" style="color: white; text-decoration: none; margin-left: 1.5rem;">Register</a>
            </nav>
        </header>
    ...
    <footer>
        <div class="footer-links">
            ...
            <a href="FarmerRegister.php">Register</a>
