...
<head>
    ...
    <meta name="description" content="Reset your AgroCraft buyer account password - Connect directly with farmers. Fair prices. No middlemen.">
            ...
            <div class="reset-card">
                ...
                <div class="reset-body">
                    <form action="BuyerForgotPassword.php" method="post">
                        ...
                        <!-- <div class="form-group">
                            <label for="pan" class="form-label"><i class="fas fa-id-card"></i> PAN Number</label>
                        ...
                        <div class="login-link">
                            <a href="BuyerLogin.php"><i class="fas fa-arrow-left"></i> Back to Login</a>
                        </div>
                    </form>
                </div>
            </div>
