...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="bhome.php">
        <img src="../auth/agro.png" class="float-left mr-5 ml-0 " alt="Logo" style="height:50px;">
    </a>
</div>
...
<a class="float-left" href="bhome.php">
    <img src="../auth/agro.png" class="float-left mr-2 moblogo" alt="Logo" style="height:50px;">
</a>
