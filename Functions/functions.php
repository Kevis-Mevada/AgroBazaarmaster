    ...
    function getUsername()
    {
        if (isset($_SESSION['phonenumber'])) {
            ...
            if ($run_query) {
                ...
                echo @"<div class='text-success logins'>$buyer_name</div>";
            }
        } else {
...
function getProducts()
{
    ...
    while ($rows = mysqli_fetch_array($run_query)) {
        ...
        if ($names = mysqli_fetch_array($running_query_name)) {
            $name = $names['farmer_name'];
        }
        
        $delivery_badge = ($product_delivery == "yes") ? 
            '<span class="badge bg-success bg-opacity-10 text-success mb-2"><i class="fas fa-truck"></i> Farmer Delivery</span>' : 
            '<span class="badge bg-secondary bg-opacity-10 text-secondary mb-2"><i class="fas fa-info-circle"></i> Pickup Only</span>';
        ...
        <div class='col'>
            <div class='card h-100 border-0 shadow-sm overflow-hidden'>
                ...
                <a href='../BuyerPortal2/ProductDetails.php?id=$product_id'>
                    <img src='../Admin/product_images/$product_image' class='card-img-top object-fit-cover' alt='$product_title' style='height: 200px;'>
                </a>
                <div class='card-body'>
                    ...
                    <a href='../BuyerPortal2/bhome.php?add_cart=$product_id' class='btn btn-success w-100 rounded-pill'>
            ...
            echo "<div class='column kolum'>
                <div class='image-container'>
                     <a href='../BuyerPortal2/Categories.php?type=$product_type'>
                        ...
                        <div class='overlay'>$product_type</div>
                     </a>
                </div>
            </div>";
        }
